    ...
    public static boolean pair(String strAddr, String strPsw) {
        ...
        if (device.getBondState() != BluetoothDevice.BOND_BONDED) {
            try {
                ...
                boolean flag1 = ClsUtis.setPin(device.getClass(), device,
                        strPsw); // 手机和蓝牙采集器配对
                boolean flag2 = ClsUtis.createBond(device.getClass(), device);
            ...
            try {
                ClsUtis.removeBond(device.getClass(), device);
